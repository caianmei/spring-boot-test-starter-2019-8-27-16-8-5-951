...
public class HomeControllerTest {
    ...
    public void shouldReturnMap() throws Exception {
        ...
        .andExpect(status().isOk())
        .andExpect(
        		MockMvcResultMatchers.jsonPath("$.user", CoreMatchers.is("Amy"))
        );
    }
    ...
    public void shouldReturnCreate() throws Exception {
    	...
    	String postString = ObjectMapper.writeValueAsString(hashMap);
        this.mockMvc.perform(
        ...
        .andExpect(
        		MockMvcResultMatchers.jsonPath("$.userId", CoreMatchers.is("001"))
        );
    }
}